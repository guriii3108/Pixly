  ...
  return (
    <div className="min-h-screen w-full bg-zinc-950 text-white font-sans selection:bg-cyan-500/30 py-10">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-8 tracking-tight bg-clip-text text-transparent bg-linear-to-b from-white to-zinc-500">
          Your Collection
        </h1>
        ...
        {collection.length > 0 && (
          <div className="flex justify-center mb-12">
            <button
              onClick={clearFullCollection}
              className="px-6 py-2 rounded-full border border-red-500/30 text-red-400 bg-red-500/10 hover:bg-red-500/20 hover:text-red-300 transition-all duration-300 text-xs font-medium tracking-widest uppercase backdrop-blur-md"
            >
              Clear Collection
            </button>
          </div>
